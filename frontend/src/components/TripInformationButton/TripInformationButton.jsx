...
const TripInformationButton = ({ to }) => {
  return (
    <Link to={to}>
    <button className="fixed bottom-6 right-6 z-50 flex items-center rounded-full bg-white p-4 text-black hover:bg-getstarted-light dark:hover:bg-getstarted-dark dark:text-white dark:bg-black">
