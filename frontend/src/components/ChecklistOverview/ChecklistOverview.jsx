      ...
      <div className="flex items-center px-3 py-10">
        <ul>
          {tasksArray.map(({ task, index }) => (
            <div
              key={index}
              className="flex items-center justify-between pb-5 text-black dark:text-white"
            >
                ...
                {editingTaskIndex === index ? (
                  <>
                    <input
                      ...
                      className="font-primary text-lg outline-none mobile:text-base sm:text-base md:text-base lg:text-lg xl:text-lg dark:text-black"
                    />
                  </>
                ) : (
